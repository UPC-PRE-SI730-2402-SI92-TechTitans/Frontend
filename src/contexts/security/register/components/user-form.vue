...
import UserName from '@/contexts/security/register/components/user-name.vue'
import UserLastname from '@/contexts/security/register/components/user-lastname.vue'
import UserEmail from '@/contexts/security/register/components/user-email.vue'
import UserPassword from '@/contexts/security/register/components/user-password.vue'
import FormActions from '@/contexts/security/register/components/form-actions.vue'
import { User } from '@/contexts/security/register/models/user-entity.js'
