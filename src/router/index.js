...
const routes = [
  ...
  { path: '/group/create-group', name: 'GroupCreate', component: GroupCreateView, meta: { requiresAuth: true } },
  { path: '/group/update-group/:id', name: 'updateGroup', component: GroupCreateView, props: true, meta: { requiresAuth: true } },
  { path: '/group/:id/expenses', name: 'groupExpenses', component: GroupExpensesView, props: true, meta: { requiresAuth: true } },
  { path: '/contacts', component: ContactManagement, meta: { requiresAuth: true } },
  { path: '/create-contact', component: ContactForm, name: 'createContact', meta: { requiresAuth: true } },
  { path: '/update-contact/:id', component: ContactForm, name: 'updateContact', meta: { requiresAuth: true } },
