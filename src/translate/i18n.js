...
const messages = {
  en: {
    homePage: {
      ...
      sectionOne: {
        paragraph1:
          'TechTitans presents FinanceGuard, an innovative platform designed to manage both personal and business finances. With the main goal of simplifying money management and improving the financial organization of its users, FinanceGuard offers an intuitive and efficient experience.',
        paragraph2:
